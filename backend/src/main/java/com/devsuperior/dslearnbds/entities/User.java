...
public class User implements Serializable {
	...
	@JoinTable(name = "tb_user_role",   ///joinColumns Pega da propria classe e o inverseJoinColumns pega o tipo que estiver na coleção
		...
		inverseJoinColumns = @JoinColumn(name = "role_id")) // nome da chave estrangeira da tabela que estou relacionando que no caso é a Role		
	private Set<Role> roles = new HashSet<>();  //-- Assossiação muitos p muitos se coloca o SET pois ele garante que não haverá repetição 
